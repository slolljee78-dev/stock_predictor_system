            ...
            <Card className="border-violet-500/20 bg-violet-500/5">
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle>Step 3: Try Signal Engine</CardTitle>
                </div>
                <CardDescription>
                  Run automated paper trades or practise manually with virtual money
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                ...
                <div className="rounded-lg bg-background/50 p-3 border border-blue-500/20">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Signal Engine results are for learning only. Real trading may differ due to market conditions, slippage, and execution prices.
                  </p>
                </div>
              </CardContent>
            </Card>
