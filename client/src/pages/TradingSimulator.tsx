...
import { AlertCircle, BarChart3, CheckCircle2, DollarSign, History, Plus, Target, TrendingDown, TrendingUp } from "lucide-react";
...
export default function TradingSimulator() {
  ...
  return (
    <DashboardLayout>
      <div className="max-w-7xl space-y-6 page-enter">

        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="space-y-3">
            <h1 className="text-4xl font-bold gradient-text">Signal Engine</h1>
                <p className="text-muted-foreground max-w-2xl">
                  Run timed automated paper trades from live signals, or use the manual paper-trading workspace to practise with available market prices before committing real money.
                </p>
                {showAdminViewModeToggle ? (
        ...
        <Card className="premium-card border-0 bg-transparent shadow-none">
          <CardContent className="grid gap-4 p-6 md:grid-cols-[1.3fr_0.7fr] md:p-8">
            <div className="space-y-3">
              ...
              <h2 className="text-2xl font-semibold tracking-tight text-foreground">Signal Engine includes an integrated paper-trading workspace.</h2>
            ...
            <div className="grid gap-3 sm:grid-cols-3 md:grid-cols-1">
              ...
              <div className="rounded-2xl border border-border/70 bg-background/40 p-4">
                ...
                <p className="mt-2 text-lg font-semibold">Virtual buys and sells from market-data analysis</p>
              </div>
              <div className="rounded-2xl border border-border/70 bg-background/40 p-4">
        ...
        <Card className="premium-card border-0 bg-transparent shadow-none">
          <CardHeader>
            ...
            <CardDescription>
              ...
              <span className="mt-2 block">Every trade is simulated and does not place a broker order. Trade history identifies whether its recorded price came from an available quote or a fallback estimate; neither is a current executable price.</span>
