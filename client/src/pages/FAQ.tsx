...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Paid subscriptions are currently in launch-preview mode, so checkout and trials are not available yet. You can create a free workspace to explore the currently available product workflow.",
  },
  {
    id: "top-4",
    category: "Pricing & billing",
    ...
    answer:
      "There is no active paid checkout at present. When paid plans launch, the cancellation and plan-change terms will be published before any purchase can be made.",
  },
  {
    id: "signals-1",
    ...
    answer:
      "Timing varies with market hours, provider availability, cached data, and scheduled checks. Review a signal's timestamp before relying on it; the Data & Access Policy is the authoritative reference for freshness and availability.",
  },
  {
    id: "signals-2",
    category: "Signals & methodology",
  ...
  },
  {
    ...
    answer:
      "No. Signals are decision support. Signal Engine timed runs are paper-trading simulations; they do not connect to a broker or execute trades with your money. Review each setup and apply your own risk limits before making any real-world decision.",
  },
  {
    id: "signals-4",
    category: "Signals & methodology",
  ...
  },
  {
    ...
    answer:
      "Checkout is not live yet. The pricing page is a launch preview and no account is upgraded through it until a future announcement confirms that paid subscriptions are available.",
  },
  {
    id: "billing-2",
    category: "Pricing & billing",
    ...
    answer:
      "The plan comparison is currently a preview of intended product tiers, not an offer to purchase. Feature availability in the current workspace is shown directly in the product.",
  },
  {
    id: "trust-1",
