...
describe("SignalAccuracyDashboard - Real Metrics", () => {
  ...
  it("renders the simulator performance title", () => {
    render(<SignalAccuracyDashboard />);
    expect(screen.getByText("Simulator Performance")).toBeDefined();
  });
  ...
  it("displays how simulator performance is calculated", () => {
    render(<SignalAccuracyDashboard />);
    expect(screen.getByText("How Simulator Performance is Calculated")).toBeDefined();
  });
