...
- [x] Complete a full Vortextrade audit covering functionality, accessibility, visual design, performance, SEO, reliability, and business impact
- [x] A1: Remove unverified public proof, placeholder support details, and unsupported guarantees
- [x] A2: Make the commercial funnel safe while Stripe is inactive
- [x] A3: Prepare a compliance-review pack for qualified external sign-off
- [ ] External launch gate: Obtain written qualified compliance sign-off before enabling paid acquisition, paid checkout, or performance marketing
- [x] A4: Secure all Heartbeat scheduler endpoints and verify authorised execution
- [x] A5: Restore a green automated test suite and add a reliable CI quality gate
- [x] A6: Triage and remediate critical and high dependency advisories
- [x] A7: Publish one canonical data freshness and plan-entitlement policy
- [x] A8: Add user-facing data-health, last-refresh, and degraded-state UI
- [x] A9: Harden scheduled simulator persistence, idempotency, and concurrency
- [x] A10: Persist alert preferences through tested account mutations
- [x] A11: Remediate high-priority accessibility and keyboard issues
- [x] A12: Improve PWA install timing so it cannot obstruct primary calls to action
- [x] A13: Reduce initial bundle weight and improve cold-start performance
- [x] A14: Unify authenticated routes and remove divergent account workflows
- [x] A15: Repair public metadata, structured data, sitemap, and crawl quality
- [x] A16: Establish Google Search Console and product-funnel measurement
- [x] External measurement gate: Confirm the Google Search Console property and submit the refreshed sitemap
- [x] Fix Google Search Console sitemap fetch failure for the public sitemap
- [x] Fix production 404 regression affecting the Vortextrade homepage and public routes
- [x] A17: Make customer-visible data sources transparent and prevent mock-data presentation
- [x] A18: Consolidate shared visual primitives and application states
- [x] A19: Publish transparent methodology and historical-performance evidence
- [x] A20: Expand SEO content only after technical and measurement foundations are verified
- [x] A21: Run end-to-end verification and deliver final checklist status
- [x] Assess Vortextrade branded-search visibility and competing-name risk
- [x] Prepare and screen distinctive alternative brand names for Vortextrade
- [ ] Prepare and screen a more premium alternative brand-name direction
- [ ] Develop and screen premium number-led alternative brand names
- [ ] Screen Level Nine as the preferred potential replacement brand
- [ ] Develop and screen a directional-plus-number premium name direction excluding Level and Signal
- [ ] Compare First Meridian and North & Nine as preferred premium replacement-brand candidates
- [ ] Develop and screen coined-root-plus-number premium alternative brand names
- [ ] Develop and screen meaningful performance-led alternative brand names
- [ ] Compare True Measure, Outcome Trading, and Point Measure Trading as preferred replacement-brand candidates
- [ ] Develop and screen simple premium one-word alternative brand names
- [x] Screen all one-word candidates and Trade/Trading title extensions for conflicts and clarity
- [ ] Develop and screen a new batch of premium coined one-word brand candidates with descriptive product taglines
- [x] Develop and screen a premium British English brand-name direction with familiar, meaningful language
- [x] Research and compare measured-performance and British nature/place brand-name directions
- [x] Develop and screen short, natural British two-word brand constructions with descriptive product taglines
- [x] Develop and screen British heritage/architecture and surname/place brand-name routes
- [x] Assess Ravenshaw as a number-free parent brand and develop clear product descriptors
- [x] Develop and screen premium Ravenshaw double-barrel brand constructions without numbers or trading terms
- [x] Develop and screen a bolder, more memorable Ravenshaw-inspired premium naming direction
- [x] Develop and screen a classic British performance plus modern lifestyle-pairing brand direction
- [x] Develop and screen fresh British surname-style names with a Ravenshaw-like premium character
- [x] Compare Thornwick and Greymark as final brand candidates for identity fit, conflict risk, and product architecture
- [x] Develop and screen a rare-root British surname-style naming shortlist with early conflict checks
- [x] Compare Ashenwick and Dunmere as final brand candidates for conflict risk and product-brand application
- [x] Prepare a clearance-gated Ashenwick rebrand plan and internal migration readiness configuration
- [x] Remove the duplicate mobile navigation close control
- [x] Remove the dead mobile homepage header space and make both header actions functional and labelled
- [x] Rename the Trading Simulator workspace consistently as Signal Engine
- [x] Add an accurate live countdown and schedule context to active Signal Engine runs
- [x] Make Quick add stock chips add their ticker directly to the watchlist with visible feedback
- [x] Show newly added stocks with clear data and signal status plus a focused Signal Engine next step
- [x] Fix watchlist database query column mismatch for stock additions and preferences
- [x] Fix desktop dashboard and Signal Engine content alignment so no page content is shifted or clipped at the left edge
- [x] Ensure Signal Engine exposes every stock currently in the user’s watchlist after Quick Add, rather than retaining only earlier selections
- [x] Add regression tests covering desktop content alignment and the watchlist-to-Signal Engine stock hand-off
- [x] Save the current project state to the connected GitHub repository
