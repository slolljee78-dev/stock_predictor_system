...
class AlertMonitoringService {
  ...
  /** Execute exactly one monitoring cycle for an authorised Heartbeat callback. */
  ...
  /** Restore the cost-optimised defaults; used by controlled tests and maintenance tasks. */
